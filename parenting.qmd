...
citation:
  author:
    - name:
        literal: Global Families Research Team
  title: "Parenting and Child Development: Positive and Negative Parental Discipline Behaviors And Child Outcomes Across 60 Countries"
  url: https://globalfamilies.quarto.pub/parenting/  
filters:
  - social-share
share:
...
<span style="font-size:55px;color:#E2231A;text-align:center;">`r emo::ji("down_arrow")`</span>
...
flowchart LR
  ...
  explained --> loweraggression[lower aggression]:::blue
  ...
  linkStyle 0,1,2,3,4 stroke:#000000,stroke-width:3px,color:black;
...
flowchart LR
  ...
  linkStyle 0,1 stroke:#000000,stroke-width:3px,color:black;
...
flowchart LR
 ...
 classDef yellow fill:#FFC20E,stroke:#000000,stroke-width:2px,color:#000000;
  ...
  linkStyle 0 stroke:#000000,stroke-width:3px,color:black;
