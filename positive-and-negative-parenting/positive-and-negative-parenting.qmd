...
* Collaborators: Professor Julie Ma, Professor Yoonsun Han, Dr. Kaitlin Ward
...
* The above could lead to statistical bias and a substantive mis-estimation of important effects. Thus, there is a conceptual argument for including as many random effects—i.e. random slopes—in a statistical model as possible.
* There is also a substantive reason: We might be interested in the *sizes* of *all* the random slopes!

# Average Relationships of Parenting And Child Outcomes
