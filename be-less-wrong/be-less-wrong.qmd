...
csl: apa.csl
citation:
  url: https://agrogan1.github.io/closeread/be-less-wrong/be-less-wrong.html
format-links: false
filters:
  - social-share
share:
  permalink: "https://agrogan1.github.io/closeread/be-less-wrong/be-less-wrong.html"
...
The fact that statistical results--and analogously visual results--can flip when more variables are accounted for is known as Simpson's Paradox [@Simpson1951; @Norton2015;  @Marang-vandeMheen2014].[^multilevelstructure] 
:::
...
My point? Simple models feel intuitive and have a commonsense appeal. Yet, with even slightly complicated social issues--especially when we have data with hundreds, or thousands, or even hundreds of thousands of cases--simple models may be wrong. [^power]$^,$ [^controls]$^,$ [^RCT]
