...
This recalls the famous saying by the statistician George Box about statistical models, reported in many places, and well captured in the passage by @Hand2014:
:::
...
:::{focus-on="cr-box2" scale-by="1.25"}
...
:::{focus-on="cr-flowchart" scale-by="3"}
...
:::{focus-on="cr-flowchart2" scale-by="3"}
