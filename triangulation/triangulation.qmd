...
:::{#cr-child-maltreatment}
![child maltreatment](child-maltreatment.png) 
:::

:::{#cr-multiple-measures .scale-to-fill}
![multiple measures from multiple reporters](multiple-measures.png) 
:::

:::{focus-on="cr-triangle" scale-by=".5"}
# Objective 
...
:::{focus-on="cr-network-analysis" scale-by=".75"}
...
:::{focus-on="cr-network-analysis" pan-to="-45%,-25%" scale-by=".75"}
Adult self-reports of abuse were most related and most predictive of adult depression. 
:::

:::{focus-on="cr-child-maltreatment" scale-by=".45"}
These findings highlight the usefulness of using advanced quantitative methods when presented with data from multiple reporters, along with the usefulness of self-reports. 
:::
