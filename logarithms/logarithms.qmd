---
title: "Logarithms"
subtitle: "An attempt to develop intuitions around an unintuitive idea"
author: 
...
filters:
  - social-share
share:
  permalink: "https://agrogan1.github.io/closeread/logarithms/logarithms.html"
...
$$\ln(\frac{p(\text{outcome})}{1-p(\text{outcome})}) = \beta_0 + \beta x$$
:::
...
$$p(\text{outcome}) = \frac{e^{\beta_0 + \beta x}}{1 + e^{\beta_0 + \beta x}}$$
:::
