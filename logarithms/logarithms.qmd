...
To *graph* or *visualize* these *log odds*, we need to solve for $p(y)$:
:::
...
:::{focus-on="cr-sigmoid"}
This function is sometimes called a *sigmoid*, and has the interesting property of mapping the interval $- \infty < x < \infty$ to $0 < y < 1$. 

This is the first step in mapping a set of *continuous* predictors to a *categorical* outcome.
:::
