...
:::{.cr-section}
:::{focus-on="cr-exponential" scale-by="5.0"}
...
:::{focus-on="cr-logarithm-if" scale-by="5.0"}
## The Logarithm
...
:::{focus-on="cr-logarithm-then" scale-by="5.0"}
...
:::{focus-on="cr-logarithm-words" scale-by="3.0"}
In words:
:::
...
:::{focus-on="cr-logarithm-example" scale-by="5.0"}
For example: 
:::

:::{#cr-logarithm-example}
...
:::{focus-on="cr-ln-definition-if" scale-by="5.0"}
:::
...
:::{focus-on="cr-ln-definition-then" scale-by="5.0"}
:::

:::{#cr-ln-definition-then}
Then 

$$\ln{\color{purple}{y}} = \color{red}{x}$$
:::

:::{focus-on="cr-odds" scale-by="5.0"}
## Logistic Regression
...
:::{focus-on="cr-log-odds" scale-by="3.0"}
...
:::{focus-on="cr-solve-for-y" scale-by="3.0"}
