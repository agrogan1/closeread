...
:::{focus-on="cr-earth"}
<span style="font-size:105px;color:red;text-align:center;">⇣</span>
...
flowchart LR
  ...
  IPV[higher levels of \nendorsement of IPV]:::blue --> pabuse[physical child abuse]:::maize
  
  CP[attitudes endorsing \ncorporal punishment]:::blue --> pabuse
...
flowchart LR
  ...
  terrorism[terrorism and \npolitical violence]:::maize --> IPV[higher levels of \nendorsement of IPV]:::blue
  
  IPV --> pabuse[physical child abuse]:::maize
...
Plot.plot({
  ...
  symbol: {legend: true},
  marks: [
    Plot.dot(mydata, {x: "pctile", 
    y: "pabuse", 
    fill: "red", 
    r: 7, 
    tip: true}),
    Plot.line(mydata, {x: "pctile", y: "pabuse", curve: "monotone-y"}),
    Plot.axisX({label: "percentile of political violence and terrorism"}),
    Plot.axisY({label: "probability of physical abuse"})
  ]
})
```
:::
...
flowchart TB
  ...
  interventions:::orange --> IPV[lower levels of \nendorsement of IPV]:::blue
  
  IPV --> pabuse[less physical child abuse]:::maize
